      ...
      <div class="container"><br><br>
        ...
        <div class="col-md-10 m-5 mx-auto bg-white" style="box-shadow: 0px 0px 20px 0px #000000b8;border-radius: 15px;"> <br>
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
              <a  class="nav-link text-dark active" id="cadastrar-tab" data-toggle="tab" href="#cadastrar" role="tab" aria-controls="cadastrar" aria-selected="true"></a>
            </li>
          </ul>
            ...
            <div class="tab-pane fade show active" id="cadastrar" role="tabpanel" aria-labelledby="cadastrar-tab">
              <div class="mx-auto col-md-12 row w-100 p-3" style="min-height: 30vh;max-height: 65vh;">
                <div class="col-md-12" style="padding-top: 20px;">
                  ...
                  <form enctype="multipart/form-data" method="POST" action="../back-end/DB/professor/editar.php?">
                    <?php
                        if (isset($_GET['id'])){
                            $prof_id = mysqli_real_escape_string($conexao, $_GET['id']);
                            $sql = "SELECT * FROM tb_professor WHERE prof_id = '$prof_id'";
                    ...
                    ?>
                    <div class="form-row">
                      <div class="form-group tg col-md-12 input-group-lg"><input type="text" class="form-control text-dark " title="Preencha este campo com o nome completo do professor" style="background-color: transparent;border: 1px solid black;" name="nome" placeholder="Nome Completo" id="nome" value="<?=$professor['prof_nome']?>" required></div>
                      <div class="form-group tg col-md-6 input-group-lg" title="Somente leitura."><input type="text" class="form-control text-dark " style="background-color: #D3D3D3;border: 1px solid black;" name="id" placeholder="ID" id="id" value="<?=$professor['prof_id']?>" readonly></div>
                      <div class="form-group tg col-md-6 input-group-lg" title="Evite sinais de pontuação e caracteres especiais."><input type="text" class="form-control text-dark " style="background-color: transparent;border: 1px solid black;" name="cpf" placeholder="CPF" id="cpf" value="<?=$professor['prof_cpf']?>" required></div>
                      <div class="form-group tg col-md-6 input-group-lg" title="Evite sinais de pontuação e caracteres especiais."><input type="text" class="form-control text-dark " style="background-color: transparent;border: 1px solid black;" name="rg" placeholder="Número do RG" id="rg" value="<?=$professor['prof_rg']?>" required></div>
                      ...
                      <div class="form-group col-md-12">
                        <button type="submit" class="btn btn-secondary w-50 ajuda1" name="update" id="update">Alterar</button>
                      </div>
                    </div>
                  </form>
                  <?php 
                        } else{
                            echo "<h5>Professor não encontrado na base de dados</h5>";
                        }
                    }
                  ?>
                </div>
