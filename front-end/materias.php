              ...
              <div class="mx-auto col-md-12 row w-100 p-3" style="min-height: 30vh;max-height: 65vh;">
                <div class="col-md-12" style="padding-top: 20px;">
                  <form method="POST" action="../back-end/DB/materia/inserir.php">
                    <div class="form-row">
                      <div class="form-group tg col-md-12 input-group-lg"><input type="text" class="form-control text-dark " style="background-color: transparent;border: 1px solid black;" name="nome" placeholder="Nome da materia" required></div>
                ...
                <div class="col-md-12" style="padding-top: 20px;">
                  <div class=" table-responsive mx-auto col-md-12">
                    <table id="table" class="table tg table-striped table-bordered table-hover" style="font-size: 14px">
                      ...
                      <tbody >
                        <?php
                          $selecione2 = "SELECT * FROM tb_disciplina";
                          $executar2 = mysqli_query($conexao, $selecione2);
                          while ($valores = mysqli_fetch_assoc($executar2)){
                            echo "<tr><td><h7 style='font-size: 14px;color: black;cursor: default;'>".$valores['dis_nome']."<td><a class='link2' href='../back-end/DB/materia/delete.php?id=".$valores['dis_id']."' title='Clique aqui para apagar esta materia".$valores['dis_nome'].".'><i class='fa fa-trash' aria-hidden='true' style='color: red;'></i></a></td></tr>";
                          };
                        ?>
                      </tbody>
                    </table>
